                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="profile-edit-container add-list-container">
                                            ...
                                            <div class="custom-form">
                                                <label>Street Address<%--<select data-placeholder="Location" class="chosen-select" >
                                                ...
                                                <div class="row">
                                                   ...
                                                   <h4>Amenities </h4>
                                                    ...
                                                    <label for="check-d">Wireless Internet</label>
                                                                ...
                                                                <asp:FileUpload ID="fupTourImage" runat="server" CssClass="upload" OnClick="btnSave_Click" />
